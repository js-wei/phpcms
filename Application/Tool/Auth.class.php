 ...
 * 
 * 4，支持规则表达式。
 *      在 think_auth_rule 表中定义一条规则时，如果type为1， 
 *	condition字段就可以定义规则表达式。 如定义{score}>5  and {score}<100  
...
-- ----------------------------
-- think_auth_rule，规则表，
-- id:主键，name：规则唯一标识, title：规则中文名称 status 
--状态：为1正常，为0禁用，condition：规则表达式，
...
-- id：主键， title:用户组中文名称， rules：用户组拥有的规则id， 
-- 多个规则","隔开，status 状态：为1正常，为0禁用
-- ----------------------------
