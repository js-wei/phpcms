...
<head>
	...
	<script type="text/javascript">
		$self='/phpcms/Admin/Config/article';
                ...
                <div class="span12">
                    <div class="portlet box purple">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="/phpcms/Admin/Config/addarticlehandler" method="post" id="form_sample_1" class="form-horizontal" novalidate="novalidate" enctype="multipart/form-data">
                                ...
                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("document")); ?></label>  <!--<span class="required">*</span>-->
                                    <div class="controls">
                                        <textarea  name="document"  class="span4 m-wrap" placeholder="<?php echo (L("document")); ?>"><?php echo ($document["document"]); ?></textarea>
                                        <label class="line-height50">(<?php echo (L("document_tip")); ?>)</label>
                                    </div>
                                </div>

                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("document_show")); ?></label>
                                    <div class="controls">
                                        <!--<textarea  name="document_show"  class="span4 m-wrap" placeholder="<?php echo (L("document_show")); ?>"><?php echo ($site["document_show"]); ?></textarea>-->
                                        <select name="document_show" id="document_show">
                                            <option value="0" <?php if(($document["document_show"]) == "0"): ?>selected<?php else: ?>selected<?php endif; ?> ><?php echo (L("document_show_item0")); ?></option>
                                            <option value="1" <?php if(($document["document_show"]) == "1"): ?>selected<?php endif; ?>><?php echo (L("document_show_item1")); ?></option>
                                            <option value="2" <?php if(($document["document_show"]) == "2"): ?>selected<?php endif; ?>><?php echo (L("document_show_item2")); ?></option>
                                        </select>
                                        <label class="line-height50">(<?php echo (L("document_show_tip")); ?>)</label>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("draft")); ?></label>
                                    <div class="controls">
                                        <select name="draft" id="draft">
                                            <option value="0"  <?php if(($document["draft"]) == "0"): ?>selected<?php else: ?>selected<?php endif; ?>><?php echo (L("draft_on")); ?></option>
                                            <option value="1" <?php if(($document["draft"]) == "1"): ?>selected<?php endif; ?>><?php echo (L("draft_off")); ?></option>
                                        </select>
                                        <label class="line-height35">(<?php echo (L("draft_tip")); ?>)</label>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("auto_save")); ?></label>
                                    <div class="controls">
                                        <input type="text" name="auto_save" value="<?php echo ($document["auto_save"]); ?>" placeholder="<?php echo (L("auto_save")); ?>"/>
                                        <label class="line-height35">(<?php echo (L("auto_save_tip")); ?>)</label>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("admin_page_size")); ?></label>
                                    <div class="controls">
                                        <input type="text" name="admin_page_size" value="<?php echo ($document["admin_page_size"]); ?>" placeholder="<?php echo (L("admin_page_size")); ?>"/>
                                        <label class="line-height50">(<?php echo (L("admin_page_size_tip")); ?>)</label>
                                    </div>
                                </div>
	...
	<script type="text/javascript">
		$(function(){
            ...
            $('#change-lang li').click(function(e){
                ...
                $.post('/phpcms/Admin/Config/article',{l:$uri},function(d){
