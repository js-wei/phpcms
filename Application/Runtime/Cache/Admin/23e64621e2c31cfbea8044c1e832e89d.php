...
<link rel="stylesheet" type="text/css" href="/phpcms/Public/Admin/media/css/datepicker.css" />
<link rel="stylesheet" type="text/css" href="/phpcms/Public/Admin/media/css/timepicker.css" />
<link rel="stylesheet" type="text/css" href="/phpcms/Public/Admin/media/css/colorpicker.css" />
<link rel="stylesheet" type="text/css" href="/phpcms/Public/Admin/media/css/bootstrap-toggle-buttons.css" />
<link rel="stylesheet" type="text/css" href="/phpcms/Public/Admin/media/css/daterangepicker.css" />
<link rel="stylesheet" type="text/css" href="/phpcms/Public/Admin/media/css/datetimepicker.css" />
<link rel="stylesheet" type="text/css" href="/phpcms/Public/Admin/media/css/multi-select-metro.css" />
<link rel="stylesheet" type="text/css" href="/phpcms/Public/Admin/media/css/bootstrap-modal.css"/>
<!--END FORM STYLE-->
<!-- BEGIN CONTAINER -->
                    ...
                    <div class="portlet box purple">
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                ...
                                <a href="javascript:;" class="reload" data-role="/phpcms/Public/Admin/media/image/fancybox_loading.gif" data-form="form_sample_1" data-reset="1"></a>
                                <a href="javascript:;" class="remove"></a>
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="/phpcms/Admin/Column/addhandler" method="post" id="form_sample_1" class="form-horizontal" novalidate="novalidate" enctype="multipart/form-data">
                                ...
                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("father")); echo (L("column")); ?><span class="required">*</span></label>
                                    <div class="controls">
                                        <select class="span4 m-wrap" name="fid">
                                            <option value="0"><?php echo (L("top")); echo (L("column")); ?></option>
                                            <?php if(is_array($column_list)): $i = 0; $__LIST__ = $column_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?><option value="<?php echo ($cate["id"]); ?>"><?php echo ($cate["html"]); echo ($cate["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("column")); echo (L("title")); ?><span class="required">*</span></label>
                                    <div class="controls">
                                        <input type="text" name="title" id="control-name" data-required="1" class="span4 m-wrap" placeholder="<?php echo (L("column")); echo (L("title")); ?>">
                                        <button type="button" id="Pinyin" class="btn blue"><?php echo (L("Pinyin")); ?></button>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("column")); echo (L("name")); ?><span class="required">*</span></label>
                                    <div class="controls">
                                        <input type="text" name="name" id="control-title" class="span4 m-wrap" placeholder="<?php echo (L("column")); echo (L("name")); ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("column")); echo (L("ico")); ?></label>
                                    <div class="controls">
                                        <input type="text" name="ico" value="" placeholder="<?php echo (L("column")); echo (L("ico")); ?>"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("column")); echo (L("banner")); ?></label>
                                    <div class="controls">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            ...
                                            <div class="input-append">
												...
												<span class="btn btn-file">
													<span class="fileupload-new"><?php echo (L("selected")); echo (L("file")); ?></span>
													<span class="fileupload-exists"><?php echo (L("revise")); echo (L("file")); ?></span>
													<input type="file" class="default" name="banner">
                                                </span>
                                                <a href="#" class="btn fileupload-exists" data-dismiss="fileupload"><?php echo (L("delete")); ?></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("column")); echo (L("description")); ?></label>
                                    <div class="controls">
                                        <textarea name="description" class="span4 m-wrap" placeholder="<?php echo (L("column")); echo (L("description")); ?>"></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("column")); echo (L("type")); ?></label>
                                    <div class="controls">
                                        <label class="radio-inline inline-width">
                                            <input type="radio" name="type"  value="1" class="reset-radio" checked><?php echo (L("list")); ?>
                                        </label>
                                        <label class="radio-inline inline-width">
                                            <input type="radio" name="type" class="reset-radio"  value="2"><?php echo (L("download")); ?>
                                        </label>
                                        <label class="radio-inline inline-width">
                                            <input type="radio" name="type" class="reset-radio"  value="3"><?php echo (L("single")); ?>
                                        </label>
                                        <label class="radio-inline inline-width">
                                            <input type="radio" name="type" class="reset-radio"  value="4"><?php echo (L("cover")); ?>
                                        </label>
                                        <label class="radio-inline inline-width">
                                            <input type="radio" name="type" class="reset-radio"  value="5"><?php echo (L("form")); ?>
                                        </label>
                                        <label class="radio-inline inline-width">
                                            <input type="radio" name="type" class="reset-radio"  value="6"><?php echo (L("redirect")); ?>
                                        </label>
                                        <label for="cover" class="hide data-cover"><input type="text" placeholder="<?php echo (L("cover")); echo (L("address")); ?>" id="cover" name="tpl"/></label>
                                        <label for="uri" class="hide data-redirect"><input type="text" placeholder="<?php echo (L("redirect")); echo (L("address")); ?>eg:http://www.baidu.com" id="uri" name="uri"/></label>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("column")); echo (L("position")); ?></label>
                                    <div class="controls">
                                        <label class="radio-inline inline-width">
                                            <input type="radio" name="position"  value="1" class="reset-radio" checked><?php echo (L("top")); ?>
                                        </label>
                                        <label class="radio-inline inline-width">
                                            <input type="radio" name="position" class="reset-radio"  value="2"><?php echo (L("center")); ?>
                                        </label>
                                        <label class="radio-inline inline-width">
                                            <input type="radio" name="position" class="reset-radio"  value="3"><?php echo (L("left")); ?>
                                        </label>
                                        <label class="radio-inline inline-width">
                                            <input type="radio" name="position" class="reset-radio"  value="4"><?php echo (L("right")); ?>
                                        </label>
                                        <label class="radio-inline inline-width">
                                            <input type="radio" name="position" class="reset-radio"  value="5"><?php echo (L("bottom")); ?>
                                        </label>
                                    </div>
                                </div>
                                <script type="text/javascript" src="/phpcms/Public/Admin/plug/My97DatePicker/WdatePicker.js"></script>
                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("column")); echo (L("effective")); ?></label>
                                    <div class="controls">
                                        <label class="radio-inline ">
                                            <input type="text" name="effective"  class="Wdate" onfocus="WdatePicker();" >
                                        </label>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("column")); echo (L("show")); ?></label>
                                    <div class="controls">
                                        <label class="radio-inline inline-width">
                                            <input type="radio" name="isnav"  value="0" class="reset-radio" checked><?php echo (L("show")); ?>
                                        </label>
                                        <label class="radio-inline inline-width">
                                            <input type="radio" name="isnav" class="reset-radio"  value="1"><?php echo (L("un_show")); ?>
                                        </label>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("column")); echo (L("status")); ?></label>
                                    <div class="controls">
                                        <label class="radio-inline inline-width">
                                            <input type="radio" name="status"  value="0" class="reset-radio" checked><?php echo (L("enable")); ?>
                                        </label>
                                        <label class="radio-inline inline-width">
                                            <input type="radio" name="status" class="reset-radio"  value="1"><?php echo (L("forbidden")); ?>
                                        </label>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("column")); echo (L("sort")); ?></label>
                                    <div class="controls">
                                        <input type="text" name="sort" value="100" placeholder="<?php echo (L("sort")); ?>"/>
                                    </div>
                                </div>
...
<script type="text/javascript" src="/phpcms/Public/Admin/media/js/bootstrap-modal.js"></script>
<script type="text/javascript" src="/phpcms/Public/Admin/media/js/bootstrap-modalmanager.js"></script>
	...
	<script type="text/javascript">
		$(function(){
            ...
            $('#change-lang li').click(function(e){
                ...
                $.post('/phpcms/Column/add',{l:$uri},function(d){
