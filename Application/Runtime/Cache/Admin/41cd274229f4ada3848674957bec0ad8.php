                    ...
                    <div class="span12">
                        <div class="portlet box purple">
                            ...
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <form action="/phpcms/Admin/Control/addhandler" method="post" id="form_sample_1" class="form-horizontal" novalidate="novalidate"  enctype="multipart/form-data">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="name" id="control-name" data-required="1" class="span4 m-wrap" placeholder="<?php echo (L("control")); echo (L("title")); ?>">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="title" id="control-title" class="span4 m-wrap" placeholder="<?php echo (L("control")); echo (L("name")); ?>">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label"><?php echo (L("control")); echo (L("description")); ?></label>
                                        <div class="controls">
                                            <textarea name="info" class="span4 m-wrap" placeholder="<?php echo (L("control")); echo (L("description")); ?>"></textarea>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <label class="radio-inline inline-width">
                                                <input type="radio" name="show"  value="0" checked><?php echo (L("show")); ?>
                                            </label>
                                            <label class="radio-inline inline-width">
                                                <input type="radio" name="show"  value="1"><?php echo (L("un_show")); ?>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="ico" value="" placeholder="<?php echo (L("control")); echo (L("ico")); ?>"/>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <label class="radio-inline inline-width">
                                                <input type="radio" name="status"  value="0" checked><?php echo (L("enable")); ?>
                                            </label>
                                            <label class="radio-inline inline-width">
                                                <input type="radio" name="status"  value="1"><?php echo (L("forbidden")); ?>
                                            </label>
                                        </div>
                                    </div>
	...
	<script type="text/javascript">
		$(function(){
            ...
            $('#change-lang li').click(function(e){
                ...
                $.post('/phpcms/Control/add',{l:$uri},function(d){
