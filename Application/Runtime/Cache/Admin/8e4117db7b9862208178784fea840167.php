...
<head>
	...
	<script type="text/javascript">
		$self='/phpcms/Admin/Config/basic';
                ...
                <div class="span12">
                    <div class="portlet box purple">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="/phpcms/Admin/Config/addbasehandler" method="post" id="form_sample_1" class="form-horizontal" novalidate="novalidate" enctype="multipart/form-data">
	...
	<script type="text/javascript">
		$(function(){
            ...
            $('#change-lang li').click(function(e){
                ...
                $.post('/phpcms/Admin/Config/basic',{l:$uri},function(d){
