...
<head>
	...
	<script type="text/javascript">
		$self='/phpcms/Admin/Control/edit?id=13';
                ...
                <div class="span12">
                    <div class="portlet box purple">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="/phpcms/Admin/Control/edithandler" method="post" id="form_sample_1" class="form-horizontal" novalidate="novalidate"  enctype="multipart/form-data">
                                ...
                                <div class="alert alert-error hide control-name">
                                    <button class="close" data-dismiss="alert"></button>
                                    <?php echo (L("control")); echo (L("not_null")); ?>
                                </div>
                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("father")); echo (L("control")); ?><span class="required">*</span></label>
                                    <div class="controls">
                                        <select class="span4 m-wrap" name="fid">
                                            <option value="0"><?php echo (L("top")); echo (L("control")); ?></option>
                                ...
                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("control")); echo (L("title")); ?><span class="required">*</span></label>
                                    <div class="controls">
                                        <input type="text" name="name" value="<?php echo ($model["name"]); ?>" id="control-name" data-required="1" class="span4 m-wrap" placeholder="<?php echo (L("control")); echo (L("title")); ?>">
                                        <button type="button" id="Pinyin" class="btn blue"><?php echo (L("Pinyin")); ?></button>
                                        <input type="hidden" name="id" value="<?php echo ($model["id"]); ?>"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("control")); echo (L("name")); ?><span class="required">*</span></label>
                                    <div class="controls">
                                        <input type="text" name="title" value="<?php echo ($model["title"]); ?>" id="control-title" class="span4 m-wrap" placeholder="<?php echo (L("control")); echo (L("name")); ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("control")); echo (L("description")); ?></label>
                                    <div class="controls">
                                        <textarea name="info"class="span4 m-wrap" placeholder="<?php echo (L("control")); echo (L("description")); ?>"><?php echo ($model["info"]); ?></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("control")); echo (L("show")); ?></label>
                                    <div class="controls">
                                        <label class="radio-inline inline-width">
                                            <input type="radio" name="show"  value="0" <?php if(($model["show"]) == "0"): ?>checked='checked'<?php endif; ?> ><?php echo (L("show")); ?>
                                        </label>
                                        <label class="radio-inline inline-width">
                                            <input type="radio" name="show"  value="1" <?php if(($model["show"]) == "1"): ?>checked='checked'<?php endif; ?> ><?php echo (L("un_show")); ?>
                                        </label>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("control")); echo (L("ico")); ?></label>
                                    <div class="controls">
                                        <input type="text" value="<?php echo ($model["ico"]); ?>" name="ico" value="<?php echo ($model["ico"]); ?>" placeholder="<?php echo (L("control")); echo (L("ico")); ?>"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("control")); echo (L("sort")); ?></label>
                                    <div class="controls">
                                        <input type="text" name="sort" value="<?php echo ($model["sort"]); ?>" placeholder="<?php echo (L("sort")); ?>"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("control")); echo (L("status")); ?></label>
                                    <div class="controls">
                                        <label class="radio-inline inline-width">
                                            <input type="radio" name="status"  value="0"  <?php if(($model["status"]) == "0"): ?>checked='checked'<?php endif; ?> ><?php echo (L("enable")); ?>
                                        </label>
                                        <label class="radio-inline inline-width">
                                            <input type="radio" name="status"  value="1" <?php if(($model["status"]) == "1"): ?>checked='checked'<?php endif; ?> ><?php echo (L("forbidden")); ?>
                                        </label>
                                    </div>
                                </div>
...
<script type="text/javascript" src="/phpcms/Public/Admin/media/js/additional-methods.min.js"></script>
	...
	<script type="text/javascript">
		$(function(){
            ...
            $('#change-lang li').click(function(e){
                ...
                $.post('/phpcms/Admin/Control/edit?id=13',{l:$uri},function(d){
