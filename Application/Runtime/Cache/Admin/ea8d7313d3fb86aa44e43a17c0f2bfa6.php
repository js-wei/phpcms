                ...
                <div class="span12">
                    <div class="portlet box purple">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="/phpcms/Admin/Config/adduserhandler" method="post" id="form_sample_1" class="form-horizontal" novalidate="novalidate" enctype="multipart/form-data">
                                ...
                                <div class="control-group">
                                    <label class="control-label"><?php echo (L("register")); ?></label>
                                    <div class="controls">
                                        <select name="register" id="register">
                                            <option value="0"  <?php if(($user["register"]) == "0"): ?>selected<?php else: ?>selected<?php endif; ?>><?php echo (L("register_on")); ?></option>
                                            <option value="1" <?php if(($user["register"]) == "1"): ?>selected<?php endif; ?>><?php echo (L("register_off")); ?></option>
                                        </select>
                                        <label class="line-height35">(<?php echo (L("register_tip")); ?>)</label>
                                    </div>
                                </div>
	...
	<script type="text/javascript">
		$(function(){
            ...
            $('#change-lang li').click(function(e){
                ...
                $.post('/phpcms/Admin/Config/user',{l:$uri},function(d){
