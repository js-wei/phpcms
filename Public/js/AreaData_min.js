...
*获取地区信息
*/
function getAddress(proId,cytyId,areaId){
	if(areaId!=0 ||areaId!="0")
		$address=area_array[proId]+' '+sub_array[proId][cytyId]+' '+ sub_arr[cytyId][areaId];
	else
		$address=area_array[proId]+' '+sub_array[proId][cytyId];
